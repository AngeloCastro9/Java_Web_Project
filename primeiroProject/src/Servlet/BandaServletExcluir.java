...
/**
 * Servlet implementation class BandaServletExcluir
 */
@WebServlet("/remover")
public class BandaServletExcluir extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BandaServletExcluir() {
        super();
    ...
    protected void service (HttpServletRequest request
    	...
    	try {
	        ...
	        out.println("<html>");
	        out.println("<body>");
	        out.println("Banda " + contato.getNome() +
